...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.lastEnergyDate":
		...
		args, err := ec.field_Query_lastEnergyDate_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `# GraphQL energystore
#
...
func (ec *executionContext) field_Query_lastEnergyDate_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["tenant"]; ok {
...
func (ec *executionContext) _Query_lastEnergyDate(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_lastEnergyDate(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Query_lastEnergyDate(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	for i, field := range fields {
		...
		case "lastEnergyDate":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_lastEnergyDate(ctx, field)
				if res == graphql.Null {
